function [orderL2,errorL2,orderH1,errorH1] = Error_Order(N1,N2,N3)
...
Number = 5; % number of refinement
errorL2 = zeros(Number,1); % L2 error
errorH1 = zeros(Number,1); % H1 error

for i=1:Number
   [errorL2(i),errorH1(i)] = run_main_rectangle_3d(N1* 2^(i-1),N2* 2^(i-1),N3*(2)^(i-1));% main function
end
